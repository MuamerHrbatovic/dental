...
Route::get('/createAppointment', 'PageController@createAppointment');
// Authentication Routes...
$this->get('login', 'Auth\LoginController@showLoginForm')->name('auth.login');
$this->get('log-in', 'Auth\LoginController@showFELoginForm');
$this->post('login', 'Auth\LoginController@login')->name('auth.login');
$this->any('logout', 'Auth\LoginController@logout')->name('auth.logout');
$this->get('register', 'Auth\RegisterController@showRegisterForm');
